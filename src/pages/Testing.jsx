  ...
  const getUniqueProperties = (arr) => {
    ...
    useEffect(()=>{
      const fetchProducts=async()=>{
        ...
        const desiredProperties = ['id', 'title','price','brand','stock','availabilityStatus'];
  
        const filteredProperties = uniqueProperties.filter(prop => desiredProperties.includes(prop));
...
{/* 
      ...
      >
        ...
        <h1 className="text-[#005B96] font-semibold text-lg">Classic and Trustworthy 1</h1>
        <h1 className="text-[#F9A825] font-semibold text-lg">Classic and Trustworthy 2</h1>
        <h1 className="text-[#C5CAE9] font-semibold text-lg">Accent Color</h1>
        <h1 className="text-[#2E3B4E] font-semibold text-lg">Modern and Sleek 1</h1>
        <h1 className="text-[#00BFA5] font-semibold text-lg">Modern and Sleek 2</h1>
        <h1 className="text-[#FF4081] font-semibold text-lg">Modern and Sleek Accent</h1>
        <h1 className="text-[#D84315] font-semibold text-lg">Warm and Inviting 1</h1>
        <h1 className="text-[#FFC107] font-semibold text-lg">Warm and Inviting 2</h1>
       
        <h1 className="text-[#3949AB] font-semibold text-lg">Cool and Calm 1</h1>
        <h1 className="text-[#00ACC1] font-semibold text-lg">Cool and Calm 2</h1>
        <h1 className="text-[#8E24AA] font-semibold text-lg">Cool and Calm Accent</h1>
        <h1 className="text-[#C2185B] font-semibold text-lg">Energetic and Vibrant 1</h1>
        <h1 className="text-[#7B1FA2] font-semibold text-lg">Energetic and Vibrant 2</h1>
        <h1 className="text-[#FFEB3B] font-semibold text-lg">Energetic and Vibrant Accent</h1>
        <h1 className="text-[#388E3C] font-semibold text-lg">Nature-Inspired 1</h1>
        <h1 className="text-[#8BC34A] font-semibold text-lg">Nature-Inspired 2</h1>
        <h1 className="text-[#FF9800] font-semibold text-lg">Nature-Inspired Accent</h1>
        <h1 className="text-[#424242] font-semibold text-lg">Elegant and Sophisticated 1</h1>
        <h1 className="text-[#FFD600] font-semibold text-lg">Elegant and Sophisticated 2</h1>
        <h1 className="text-[#673AB7] font-semibold text-lg">Elegant and Sophisticated Accent</h1>
        <h1 className="text-[#536DFE] font-semibold text-lg">Fun and Playful 1</h1>
        <h1 className="text-[#8BC34A] font-semibold text-lg">Fun and Playful 2</h1>
        <h1 className="text-[#FFC107] font-semibold text-lg">Fun and Playful Accent</h1>
        </div>

        <div className=" min-h-48 bg-[#00ACC1] rounded-md shadow-md">
        <h1>Samsu</h1>
        <h1 className="text-[#2E3B4E] font-semibold text-lg">Modern and Sleek 1</h1>
        <h1 className="text-[#F9A825] font-semibold text-lg">Modern and Sleek 2</h1>
        <h1 className="text-[#C5CAE9] font-semibold text-lg">Accent Color</h1>
