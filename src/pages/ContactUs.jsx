...
const ContactUsPage = () => {
  return (
    ...
    <Navbar/>
      ...
      style={{ backgroundImage: `url('/tbus1.jpg')`,height:'calc(100vh - 4rem)' }}
    >
 <div className="bg-white bg-opacity-80 p-8 rounded-lg shadow-lg max-w-4xl w-full flex flex-col md:flex-row">
        <div className="flex-1 p-6 ">
          <h2 className="text-2xl font-bold mb-4 text-center text-primary">Contact Information</h2>
          <div className="space-y-4">
            <div>
              <h3 className="text-lg font-medium">Phone</h3>
              <p className="text-gray-700"><a href='tel:+197542067763'>+91-7542067763</a></p>
            </div>
            <div>
